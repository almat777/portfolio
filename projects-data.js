...
const projectsData = [
    ...
    {
        id: 5,
        titleEn: "Voice Conversion Deep Learning System",
        titleRu: "Система Глубокого Обучения для Конверсии Голоса",
        descEn: "Trained a custom voice conversion RVC model from scratch for 6 hours using RTX 3050 (4GB VRAM), demonstrating optimization skills for limited hardware resources. Implemented comprehensive audio preprocessing pipeline using UVR5 for noise reduction, reverb removal, and vocal isolation before training. Applied both custom-trained models and pre-trained RVC models (Alastor from Hazbin Hotel) to create AI covers of popular songs, achieving high-quality voice transformations with 20-40 second inference time. Successfully demonstrated voice conversion across multiple languages (Kazakh, Russian, English) and different vocal styles.",
        descRu: "Обучил кастомную RVC модель конверсии голоса с нуля в течение 6 часов, используя RTX 3050 (4GB VRAM), демонстрируя навыки оптимизации для ограниченных аппаратных ресурсов. Реализовал комплексный конвейер предобработки аудио с использованием UVR5 для шумоподавления, удаления реверберации и изоляции вокала перед обучением. Применил как кастомно обученные модели, так и предобученные RVC модели (Аластор из Hazbin Hotel) для создания AI каверов популярных песен, достигнув высококачественной трансформации голоса со временем обработки 20-40 секунд. Успешно продемонстрировал конверсию голоса на нескольких языках (казахский, русский, английский) и различных вокальных стилях.",
        media: [
            { type: "audio", src: "media/audio/Unstoppable_Alastor.mp3", label: "Alastor AI Cover - Unstoppable (Sia)", labelRu: "Alastor AI Кавер - Unstoppable (Sia)" },
            { type: "audio", src: "media/audio/iseefire_alastor.mp3", label: "Alastor AI Cover - I See Fire (Ed Sheeran)", labelRu: "Alastor AI Кавер - I See Fire (Ed Sheeran)" },
            { type: "audio", src: "media/audio/songArs.mp3", label: "Original Voice", labelRu: "Оригинальный Голос" },
            { type: "audio", src: "media/audio/Adil_sings_shit.wav", label: "Custom Trained Model - Transformed Voice", labelRu: "Кастомно Обученная Модель - Преобразованный Голос" }
        ],
        tech: ["Deep Learning", "RVC", "PyTorch", "UVR5", "Audio Processing", "Voice Conversion", "Model Training", "RTX 3050", "VRAM Optimization", "Voice Cloning"],
        links: []
    },
    {
        id: 6,
